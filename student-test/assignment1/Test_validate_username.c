...
void test_validate_my_username()
{
    ...
    char* username_file = malloc_username_from_conf_file();

    TEST_ASSERT_EQUAL_STRING_MESSAGE(hardcoded_username, username_file,
                                     "Username in my_username() does not match with username specified in conf file!");
